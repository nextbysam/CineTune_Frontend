...
export const LOCAL_FONT_MAPPING: Record<
	string,
	{ url: string; postScriptName: string }
> = {
	// Montserrat fonts
	Montserrat: {
	...
	// Inter fonts
	Inter: {
		url: "/fonts/Inter_28pt-Regular.ttf",
		postScriptName: "Inter_28pt-Regular",
	},
	Inter_28pt: {
		url: "/fonts/Inter_28pt-Regular.ttf",
		postScriptName: "Inter_28pt-Regular",
	...
	"Inter_28pt-Bold": {
		url: "/fonts/Inter_28pt-SemiBold.ttf",
		postScriptName: "Inter_28pt-SemiBold",
	},
	"Inter-Bold": {
		url: "/fonts/Inter_28pt-SemiBold.ttf",
		postScriptName: "Inter_28pt-SemiBold",
	...
	"Inter_28pt-Thin": {
		url: "/fonts/Inter_28pt-Thin.ttf",
		postScriptName: "Inter_28pt-Thin",
	},
	...
	"InstrumentSerif-Italic": {
		url: "/fonts/InstrumentSerif-Italic.ttf",
		postScriptName: "InstrumentSerif-Italic",
	},

	// Cinzel fonts
	Cinzel: {
		url: "/fonts/Cinzel-Regular.ttf",
	...
	"Cinzel-Bold": {
		url: "/fonts/Cinzel-Bold.ttf",
		postScriptName: "Cinzel-Bold",
	},
	"Cinzel-SemiBold": {
		url: "/fonts/Cinzel-SemiBold.ttf",
		postScriptName: "Cinzel-SemiBold",
	},
	"Cinzel-Medium": {
		url: "/fonts/Cinzel-Medium.ttf",
		postScriptName: "Cinzel-Medium",
	},
	"Cinzel-ExtraBold": {
		url: "/fonts/Cinzel-ExtraBold.ttf",
		postScriptName: "Cinzel-ExtraBold",
	},
	"Cinzel-Black": {
		url: "/fonts/Cinzel-Black.ttf",
